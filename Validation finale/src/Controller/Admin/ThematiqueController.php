...
class ThematiqueController extends AbstractController
{
    ...
    public function addThematique(Request  $request) {
        ...
        return $this->render('admin/thematique/ajouter_thematique.html.twig',array('f'=>$form->createView())); // yab9a fi form
    ...
    public function  affichageThematique() {
        ...
        return $this->render("admin/thematique/afficher_thematique.html.twig",array("thematique"=>$them));
    }
    ...
    public function modifierThematique(Request $req, $id) {
        ...
        return $this->render('admin/thematique/modifier_thematique.html.twig',array("f"=>$form->createView()));
