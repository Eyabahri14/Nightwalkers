...
class DiscussionController extends AbstractController
{
    ...
    public function addDiscussion(Request $request) {
        ...
        return $this->render('admin/discussion/ajouter_discussion.html.twig',array('f'=>$form->createView())); // yab9a fi form
    ...
    public function  affichagediscussion() {
        ...
        return $this->render("admin/discussion/afficher_discussion.html.twig",array("discussion"=>$disc));
    }
    ...
    public function modifierDiscussion(Request $req, $id) {
        ...
        return $this->render('admin/discussion/modifier_discussion.html.twig',array("f"=>$form->createView()));
    }
